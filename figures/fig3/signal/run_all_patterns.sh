#!/usr/bin/env bash
# Run plot_pattern_mfe_and_signal.py over selected TF-MoDISco patterns:
#   profile pos_patterns : 6 7 8 13 19 35 37
#   count   pos_patterns : 2 4 5 6 7 8 9 10 11
# Outputs land in this folder as profile_pattern_<N>_mfe_and_signal.{pdf,png}
# and count_pos_pattern_<N>_mfe_and_signal.{pdf,png}.
...
SCRIPT=plot_pattern_mfe_and_signal.py
JOBS=${JOBS:-8}          # fold workers per pattern; override with: JOBS=16 bash run_all_patterns.sh
mkdir -p logs
