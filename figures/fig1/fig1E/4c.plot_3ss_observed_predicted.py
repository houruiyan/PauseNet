#!/usr/bin/env python3
"""Plot one 3' splice-site observed/predicted profile as a vector PDF."""
...
DEFAULT_OUTPUT = Path(__file__).with_name(
    "hek293t_3ss_observed_predicted_example.pdf"
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Plot one 3SS observed/predicted profile.",
