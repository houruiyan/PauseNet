#!/usr/bin/env python3
"""Plot one TES observed/predicted PauseNet profile as a vector PDF."""
...
DEFAULT_OUTPUT = Path(__file__).with_name(
    "hek293t_tes_observed_predicted_example.pdf"
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Plot one TES observed/predicted profile.",
