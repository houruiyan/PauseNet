...
DEFAULT_WORK_DIR = (
    "/mnt/HDD8TB/houruiyan/pausing_site/4_plot_figure/fig6/"
    "fig6B_supp/model_test_evaluations"
)
DEFAULT_OUTPUT = (
    "/mnt/HDD8TB/houruiyan/pausing_site/4_plot_figure/fig6/"
    "fig6B_supp/cross_cell_count_prediction_heatmap.pdf"
)
...
def plot_heatmap(
    ...
    fig.subplots_adjust(left=0.19, right=0.79, bottom=0.25, top=0.87)
    ...
    colorbar_ax = fig.add_axes([0.84, 0.25, 0.025, 0.62])
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--title",
        default="Cross-cell count prediction",
